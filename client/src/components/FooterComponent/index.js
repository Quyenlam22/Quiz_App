            ...
            <Flex justify="space-between" gap={'middle'}>
                ...
                <div className="footer__box">
                    ...
                    <ul className="footer__box__content">
                        <li><Link to="/topics" className="footer__box__desc">New Quiz</Link></li>
                        <li><Link to="/topics" className="footer__box__desc">List Quizzes</Link></li>
                        <li><Link to="/topics" className="footer__box__desc">Current trends</Link></li>
